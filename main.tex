...
\begin{flushleft}
{\Large
\textbf\newline{It's better to forget: exploring the role of stigmergy decay in navigation behavior} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
...
\input{tex/results_and_discussion.tex}
